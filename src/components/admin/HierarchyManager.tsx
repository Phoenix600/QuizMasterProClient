...
import { 
  Plus, Search, Code, Trash2, Layers, BookOpen, Edit, CheckCircle2, ChevronLeft, Trophy, Clock
} from 'lucide-react';
              ...
              <div className="lg:col-span-7 bg-[#1a1a1a] border border-white/5 rounded-3xl p-6 flex flex-col h-[600px]">
                ...
                {!adminSelectedChapter ? (
                  ...
                  <>
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 overflow-y-auto pr-1 custom-scrollbar mb-4 py-1">
                      {(chapterQuizzes[adminSelectedChapter._id] || [])
                        ...
                        <div
                          ...
                          className={`relative p-5 rounded-2x border transition-all cursor-pointer group flex flex-col justify-between ${
