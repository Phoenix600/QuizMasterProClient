      ...
      <Card className="p-12 text-center space-y-8 overflow-hidden relative" hover={false}>
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="space-y-4">
            <h2 className={`text-4xl font-bold tracking-tight ${isPassed ? 'text-green-500' : 'text-red-500'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-2">
              <div className="text-xs font-bold text-zinc-500 tracking-tight">Your Score</div>
              <div className={`text-3xl font-bold ${isPassed ? 'text-green-500' : 'text-red-500'}`}>
                {result.score}%
              </div>
            </div>
            <div className="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-2">
              <div className="text-xs font-bold text-zinc-500 tracking-tight">Correct</div>
              <div className="text-3xl font-bold text-white">
                {result.correctAnswers} / {result.totalQuestions}
              </div>
            </div>
            <div className="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-2">
              <div className="text-xs font-bold text-zinc-500 tracking-tight">Time Taken</div>
              <div className="text-3xl font-bold text-white">
